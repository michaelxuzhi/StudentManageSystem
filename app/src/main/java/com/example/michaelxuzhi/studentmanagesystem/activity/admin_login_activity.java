package com.example.michaelxuzhi.studentmanagesystem.activity;
        ...
        import com.example.michaelxuzhi.studentmanagesystem.R;
        import com.example.michaelxuzhi.studentmanagesystem.tools.myDatabaseHelper;
...
public class admin_login_activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button login = (Button) findViewById(R.id.admin_login_activity_login);
        TextView register = (TextView) findViewById(R.id.admin_login_activity_register);
        TextView forgetNum = (TextView) findViewById(R.id.admin_login_activity_forgetNum);
